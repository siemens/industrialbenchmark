...
public class MissingPropertyException extends PropertiesException {
	...
	public MissingPropertyException(final String aMessage, final Throwable aThrowable, final Properties aProperties, final String aKey) {
		super(aMessage, aThrowable, aProperties, aKey);
	}

	public MissingPropertyException(final Properties aProperties, final String aKey) {
